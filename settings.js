...
(async function () {
    try {
        ...
        // Get lists from the args passed when opening the popup
        console.log('Getting context args...');
        const context = t.getContext();
        console.log('Context:', context);

        // Get the lists that were passed as arguments
        const args = await t.arg('lists');
        console.log('Lists from args:', args);
        ...
        console.log('Populating dropdown with', args.length, 'lists');
